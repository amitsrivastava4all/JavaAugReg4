...
public class Player implements GameConstants, PlayerState {
	...
	public void jump(){
		logger.debug("Inside Jump "+isJump+" Force "+force);
		if(!isJump){
		force = -20;
		y = y + force;
		isJump = true;
		logger.debug("Inside Jump If Now Force is "+force+" Now isJump is "+isJump);
		}
	}
	...
	private void loadSpriteSheet(){
		try {
			spriteSheet = ImageIO.read(Player.class.getResource("player11.gif"));
